...
class BaseCleanText:
    ...
    def remove_special_characters(self, text):
        ...
        Example:
            "Hola! cómo estás?" will be converted to "Hola cómo estás".
        """
    ...
    def remove_accents(self, text):
        ...
        Example: 
            "café" will be converted to "cafe".
        """
    ...
    def remove_n_tilde(self, text):
        ...
        Example:
            "mañana" will be converted to "manana".
        """
    ...
    def replace_spaces_by_underscores(self, text):
        ...
        Example:
            "hello world" will be converted to "hello_world".
        """
    ...
    def replace_underscores_by_spaces(self, text):
        ...
        Example:
            "hello_world" will be converted to "hello world".
        """
